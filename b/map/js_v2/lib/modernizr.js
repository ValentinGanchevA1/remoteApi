 ...
 * Build: http://modernizr.com/download/#-fontface-inlinesvg-svg-svgclippaths-touch-shiv-mq-cssclasses-teststyles-prefixes-ie8compat-load
 */
;
...
/*sprawdzenie czy na jest ie*/
var d = document.getElementsByTagName("html")[0];
var t = /(IEMobile)|(XBLWP)|(ZuneWP)/.test(navigator.userAgent);
if (t) d.className = d.className + " no-fontface-ua ";