...
export function validateResidenceCardNumber(number) {
...
export function validatePesel(pesel) {
    ...
    var checkIfFakePesel = function(pesel) {
 ...
 */
export function validateForeignerPesel(pesel) {
    return validatePesel(pesel) && ['8', '9'].includes(pesel[2]);
}

export function validateCensoredPesel(pesel) {
    let reg = /^XXXXXXXXXX[0-9]{1}$/;
 ...
 */
export function validateIfAdult(pesel) {
...
export function validateNIP(nip) {
    var checkDifferentValues = function(s) {
    ...
    var checkControlValue = function(s) {
        var sum = 0;
...
export function validateREGON(regon) {
    ...
    var getSum = function(regon, weights) {
        var sum = 0;
