define(["exports"], function(_exports) {
    ...
    var OraDispatcher = function(OraDispatcher) {
        ...
        OraDispatcher.dispatch = function(payload) {
            console.log("Dispatching action ".concat(payload.type, ". Payload:"), payload);
            ...
            try {
                ...
                console.log("Stop dispatching action ".concat(payload.type, ". Payload:"), payload);
        ...
        function _invokeCallback(id) {
            ...
            try {
                ...
                console.log("Error while invoking store action handler: ".concat(e, "\n ").concat(e.stack));
            }
