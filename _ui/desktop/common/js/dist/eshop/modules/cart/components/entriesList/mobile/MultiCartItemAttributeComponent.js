define(["exports", "react", "./MultiCartItemTooltip", "eshop/components/OraStockLevelStatusComponent"], function(_exports, _react, _MultiCartItemTooltip, _OraStockLevelStatusComponent) {
    "use strict";
    ...
    var MultiCartItemAttributeComponent = /*#__PURE__*/ function(_Component) {
        ...
        babelHelpers.createClass(MultiCartItemAttributeComponent, [{
            ...
            value: function getPriceSpelling(price) {
                ...
                } else if (!price.monthTo && price.monthFrom) {
            ...
            value: function getPricesTooltip(allPrices, additionals) {
                var _this = this;

                var prices = allPrices && allPrices.length > 1 && allPrices.map(function(element, idx) {
                    return /*#__PURE__*/ _react.default.createElement("li", {
                        key: idx
                    }, _this.getPriceSpelling(element), ": ", /*#__PURE__*/ _react.default.createElement("b", null, element.price, "\xA0", element.currency));
                });
            ...
            key: "getTooltip",
            value: function getTooltip(content) {
                return /*#__PURE__*/ _react.default.createElement(_MultiCartItemTooltip.default, null, content);
            }
        }, {
