    ...
    var MultiCartMnpBenefitComponent = /*#__PURE__*/ function(_Component) {
        ...
        babelHelpers.createClass(MultiCartMnpBenefitComponent, [{
            ...
            value: function getMnpBenefitData(processType, mnpData, monthlyPrices) {
                ...
                if (monthlyPrices && (monthlyPrices[0].originalGrossPrice == 0 || monthlyPrices[0].price === 0) && monthlyPrices[0].monthTo) {
            ...
            value: function render() {
                ...
                }, "Dla przenosz\u0105cych numer ", formattedMonth, " za darmo!", this.props.tooltip && /*#__PURE__*/ _react.default.createElement(_MultiCartItemTooltip.default, null, this.props.tooltip)) : null;
            }
        }]);
