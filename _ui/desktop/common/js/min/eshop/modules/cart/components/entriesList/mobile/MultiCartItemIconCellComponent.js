define(["exports", "react"], function(e, c) {
    ...
    var r = function(e) {
        ...
        return babelHelpers.createClass(n, [{
            key: "render",
            value: function() {
                var e, t; - 1 !== ["SIM", "VAS", "GADGET", "DATA", "BROADBAND", "TV", "MOBILE_VOICE", "VOIP"].indexOf(this.props.entryType) ? (e = this.props.icon || this.productIcons[this.props.entryType], t = this.cellTypes.ICON) : "TERMINAL" === this.props.entryType && (t = this.cellTypes.IMAGE);
                var r = " u-vertical-top  u-padding-top-l";
                return document.getElementById("ora-product-list-header-component") && (r = " u-vertical-middle "), c.default.createElement("td", {
                    rowSpan: this.props.rowSpan || void 0,
                    className: t + ("VAS" !== this.props.entryType ? r : "")
