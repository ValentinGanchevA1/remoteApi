define(["exports", "react", "./MultiCartItemTooltip", "eshop/components/OraStockLevelStatusComponent"], function(e, a, l, t) {
    "use strict";
    ...
    var r = function(e) {
        ...
        return babelHelpers.createClass(r, [{
            ...
            value: function(e) {
                return !e.monthTo || e.monthFrom && 1 !== e.monthFrom ? !e.monthTo && e.monthFrom ? "od " + e.monthFrom + " miesiąca" : "od " + e.monthFrom + " do " + e.monthTo + ". miesiąca" : 1 === e.monthTo ? "przez pierwszy miesiąc" : 1 < e.monthTo && e.monthTo < 5 ? "przez pierwsze " + e.monthTo + " miesiące" : 5 <= e.monthTo ? "przez pierwsze " + e.monthTo + " miesięcy" : "do " + e.monthTo + ". miesiąca"
            }
        }, {
                ...
                var r = this,
                    t = e && 1 < e.length && e.map(function(e, t) {
                        return a.default.createElement("li", {
                            key: t
                        }, r.getPriceSpelling(e), ": ", a.default.createElement("b", null, e.price, " ", e.currency))
                    });
                if (t) return a.default.createElement(l.default, null, a.default.createElement("div", null, "Opłaty miesięczne:"), a.default.createElement("ul", null, t))
            }
        }, {
            key: "getTooltip",
            value: function(e) {
                return a.default.createElement(l.default, null, e)
            }
        }, {
