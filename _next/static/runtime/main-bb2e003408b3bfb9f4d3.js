(window.omniJsonp = window.omniJsonp || []).push([
    [44], {
            ...
            t.__esModule = !0, t.observeLayoutShift = function(e) {
                if (a("layout-shift")) {
                    ...
                    r.observe({
                        ...
                        "hidden" === document.visibilityState && (r.takeRecords(), r.disconnect(), document.removeEventListener("visibilitychange", n, !0), e({
                ...
                if (a("largest-contentful-paint")) {
                    ...
                    new PerformanceObserver((function(e) {
                        ...
                        t && "hidden" === document.visibilityState && (document.removeEventListener("visibilitychange", r, !0), e({
        ...
        ioxi: function(e, t, r) {
            ...
            var l = r("pONU"),
                p = r("Y3ZS");
            t.__esModule = !0, t.render = V, t.renderError = z, t.default = t.emitter = t.router = t.version = void 0;
            var d = p(r("9YZO")),
                m = (p(r("pONU")), p(r("ERkP"))),
                h = p(r("7nmT")),
                v = p(r("jRQF")),
                ...
                R = r("Lko9"),
                S = r("awAI");
            "finally" in Promise.prototype || (Promise.prototype.finally = r("m9ql"));
            ...
            var Z = function(e) {
                    ...
                    return a(n, [{
                        ...
                        value: function() {
                            this.scrollToHash(), F.isSsr && (L || C.nextExport && ((0, R.isDynamicRoute)(F.pathname) || location.search) || k.__N_SSG && location.search) && F.replace(F.pathname + "?" + (0, P.stringify)((0, d.default)({}, F.query, {}, (0, P.parse)(location.search.substr(1)))), j, {
                                _h: 1,
                                shallow: !L
                            })
                        }
                ...
                return n.async((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        ...
                        case 7:
                            ...
                            break;
                        case 9:
                            return t.prev = 9, t.t0 = t.catch(4), t.next = 13, n.awrap(z((0, d.default)({}, e, {
                                err: t.t0
                            })));
                        case 13:
                        case "end":
                ...
                return n.async((function(u) {
                    for (;;) switch (u.prev = u.next) {
                        case 0:
                            ...
                            break;
                        case 3:
                            return console.error(r), u.next = 7, n.awrap(q.loadPage("/_error"));
                        case 7:
                            if (o = u.sent, Y = o.page, a = ae(t), i = {
                                    Component: Y,
                                    AppTree: a,
                                    router: F,
                                    ctx: {
                            ...
                            break;
                        case 15:
                            return u.next = 17, n.awrap((0, E.loadGetInitialProps)(t, i));
                        case 17:
                            u.t0 = u.sent;
                        case 18:
                            return c = u.t0, u.next = 21, n.awrap(ie((0, d.default)({}, e, {
                                err: r,
                                Component: Y,
                                props: c
                            })));
            ...
            t.default = function(e) {
                ...
                return n.async((function(u) {
                    for (;;) switch (u.prev = u.next) {
                        case 0:
                            return (void 0 === e ? {} : e).webpackHMR, u.next = 4, n.awrap(q.loadPageScript("/_app"));
                        case 4:
                            return r = u.sent, o = r.page, a = r.mod, X = o, a && a.unstable_onPerformanceData && ($ = function(e) {
                                var t = e.name,
                                    r = e.startTime,
                                    n = e.value,
                                    o = e.duration,
                            ...
                            }), i = I, u.prev = 10, u.next = 14, n.awrap(q.loadPage(T));
                        case 14:
                            c = u.sent, G = c.page, u.next = 20;
                            break;
                        case 20:
                            u.next = 25;
                            break;
                        ...
                        case 25:
                            ...
                            return u.next = 28, n.awrap(window.__NEXT_PRELOADREADY(B));
                        case 28:
                            return t.router = F = (0, y.createRouter)(T, N, j, {
                                initialProps: k,
                                pageLoader: q,
                                App: X,
                                Component: G,
            ...
            var K = "function" === typeof h.default.hydrate;

            function ee(e, t) {
                if (E.ST && performance.mark("beforeRender"), K ? (h.default.hydrate(e, t, te), K = !1) : h.default.render(e, t, re), $ && E.ST) try {
                    (0, S.observeLayoutShift)($), (0, S.observeLargestContentfulPaint)($), (0, S.observePaint)($)
                } catch (r) {
            ...
            function te() {
                E.ST && (performance.mark("afterHydrate"), performance.measure("Next.js-before-hydration", "navigationStart", "beforeRender"), performance.measure("Next.js-hydration", "beforeRender", "afterHydrate"), $ && (performance.getEntriesByName("Next.js-hydration").forEach($), performance.getEntriesByName("beforeRender").forEach($)), ne())
            }
            ...
            function ie(e) {
                var t, r, o, a, i, c, u, s, f, l, p;
                return n.async((function(h) {
                    for (;;) switch (h.prev = h.next) {
                        case 0:
                            if (t = e.App, r = e.Component, o = e.props, a = e.err, o || !r || r === Y || H.Component !== Y) {
                                h.next = 8;
                                break
                            }
                            return c = (i = F).pathname, u = i.query, s = i.asPath, f = ae(t), l = {
                                router: F,
                                AppTree: f,
                                Component: Y,
                                ctx: {
                            ...
                            }, h.next = 7, n.awrap((0, E.loadGetInitialProps)(t, l));
                        case 7:
                            o = h.sent;
                        case 8:
                            r = r || H.Component, o = o || H.props, p = (0, d.default)({}, o, {
                                Component: r,
                                err: a,
                                router: F
                            }), H = p, J.emit("before-reactdom-render", {
                                Component: r,
                                ErrorComponent: Y,
                                appProps: p
                            }), ee(m.default.createElement(oe, null, m.default.createElement(t, p)), W), J.emit("after-reactdom-render", {
                                Component: r,
                                ErrorComponent: Y,
                                appProps: p
                            });
        ...
        jRQF: function(e, t, r) {
            ...
            function o(e) {
                ...
                return u ? o.innerHTML = u.__html || "" : c && (o.textContent = "string" === typeof c ? c : c.join("")), o
            }
        },
        m9ql: function(e, t) {
        ...
        vOaH: function(e, t, r) {
            ...
            var h = function() {
                function e(t, r) {
                    n(this, e), this.buildId = t, this.assetPrefix = r, this.pageCache = {}, this.pageRegisterEvents = (0, c.default)(), this.loadingRoutes = {}, this.promisedBuildManifest = new Promise((function(e) {
                ...
                return o(e, [{
                    ...
                    value: function(e, t) {
                        ...
                        if (h) {
                            ...
                            r = m, Object.keys(y).every((function(e) {
                                var t = g[e],
                                    n = y[e].repeat;
                                return n && !Array.isArray(t) && (t = [t]), e in g && (r = r.replace("[" + (n ? "..." : "") + e + "]", n ? t.map(encodeURIComponent).join("/") : encodeURIComponent(t)))
                            })) || (r = "")
                        }
                        return h ? r && o(r) : o(m)
                    }
...
//# sourceMappingURL=main-bb2e003408b3bfb9f4d3.js.map