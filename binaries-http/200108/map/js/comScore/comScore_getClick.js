...
if (typeof PTK.Comscore == "undefined") {
    PTK.Comscore = {
        ...
        comScore_makeClick: function(a) {
            PTK.Comscore.udm_("http" + (document.location.href.charAt(4) == "s" ? "s://sb" : "://b") + ".scorecardresearch.com/b?" + PTK.Comscore.clickParam + "&" + PTK.Comscore.clientData);
            ns_pixelUrl = ns_p.src;
            PTK.Comscore.ns_onclick(this, "", PTK.Comscore.clickParam + "&" + PTK.Comscore.clientData + "&" + a, "hidden")
        },
