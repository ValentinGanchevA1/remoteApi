...
Autocompleter.Base = Class.create({
    baseInitialize: function(b, c, a) {
        ...
        this.options.minChars = (this.options.minChars >= 0) ? this.options.minChars : 1;
...
Ajax.Autocompleter = Class.create(Autocompleter.Base, {
    ...
    getUpdatedChoices: function() {
        ...
        this.sendRequest(this.url, this.options)
    },
...
if (typeof PTK.Ajax == "undefined") {
    PTK.Ajax = {
        ...
        popupCallback: function(f, a) {
            ...
            if (f.responseText.indexOf("window.location") > -1) {
                PTK.Ajax.checkRedirect(j, a)
            }
            var g = j.p;
            var h = "popupClass";
            var k = new RegExp("[?|&]" + h + "=(.*?)&");
        ...
        defaultCallback: function(serverResponse, id, updateResult) {
            try {
                var response = [],
                    ...
                    updatedEls = [];
                if (serverResponse.responseText.indexOf("window.location") > -1) {
                    PTK.Ajax.checkRedirect(meta, id)
                }
        ...
        extractAndStripAsyncScriptPaths: function(b) {
            ...
            if (c.length > 1) {
                c.each(function(l, j) {
                    ...
                    if (h && g) {
                        var m = g.indexOf("http") != -1 ? g : "/binaries-http/200401/map/js/" + g + ".js";
                        e.push(m)
                    }
                    a.push(k[1])
                });
        ...
        checkRedirect: function(f, c) {
            if (f.rd) {
                var e = $(document.body);
                if (!e.hasClassName("o-popup-hide")) {
                    e.addClassName("o-popup-hide");
                    var b = $(c + "-curtain");
                    if (b) {
                        var a = document.viewport.getWidth();
                        var d = document.viewport.getHeight();
                        b.addClassName("content-cover");
                        b.insert('<div style="width: ' + a + "px; height: " + d + 'px;"></div>')
                    }
                }
            }
        }
    ...
    PTK.InputHint = Class.create({
        ...
        titleHint: function(b, d) {
            ...
            if (b.getValue() === "" && b !== document.activeElement) {
                c.removeClassName("accessible-hide g-hide")
            }
        ...
        onInputBlur: function(a) {
            if (a.target.getValue() === "") {
                this.getLabel(a.target.id).removeClassName("accessible-hide g-hide");
        ...
        onFocusHandler: function(a) {
            this.getLabel(a.target.id).addClassName("accessible-hide g-hide");
        ...
        createLabel: function(d) {
            var e = new Element("label", {
                "for": d.id,
                id: "label-" + d.id,
                "class": "ptk-inputhint-label placeholder"
            ...
            e.addClassName("accessible-hide g-hide");
            return e
        }
    })
};
...
function searchBasicCustomize(b) {
    ...
    if (typeof b != "undefined" && b) {
        initializeSearchAutocompleter(b)
    }
}
...
function initializeSearchAutocompleter(a) {
    Ajax.Autocompleter.prototype.updateChoices = function(d) {
        if (!this.changed && this.hasFocus) {
    ...
    Ajax.Autocompleter.prototype.onKeyPress = function(b) {
        if (this.active) {
            switch (b.keyCode) {
                case Event.KEY_TAB:
                case Event.KEY_RETURN:
            ...
            if (b.keyCode == Event.KEY_TAB || b.keyCode == Event.KEY_RETURN || (Prototype.Browser.WebKit > 0 && b.keyCode == 0)) {
                return
            }
        }
        this.changed = true;
    ...
    PTK.auto_completer = new Ajax.Autocompleter("searchPhrase", "search-result", a, {
        paramName: "q",
        minChars: 3,
    ...
    PTK.auto_completer.options.onComplete = function(c) {
        ...
        d += "</ul>";
        PTK.auto_completer.updateChoices(d)
    };
    PTK.auto_completer.index = "undefined"
};
var PTK;
...
if (typeof PTK.FbLike == "undefined") {
    PTK.FbLike = {
        ...
        setOpenGraphMetaContent: function(b, d) {
            var a = $(b),
                c = $$("head meta[property=" + d + "]");
            if (a && c.length > 0) {
                c.first().content = a.value
            }
        }
    }
};
...
if ((Prototype.Browser.Gecko || Prototype.Browser.IE || Prototype.Browser.Opera || Prototype.Browser.WebKit) && !($$(".using-dojo").length && $$("body")[0].hasClassName("ie8"))) {
    $$("body")[0].on("mouseup", "a, input:submit, input:image", function(a) {
...
if (typeof PTK.AssetLoader == "undefined") {
    PTK.AssetLoader = {
        scriptLoaderOptions: {
            preserveOrder: true,
            appendTo: "body"
        ...
        script: function(a, b) {
            $LAB.setOptions({
                AlwaysPreserveOrder: this.scriptLoaderOptions.preserveOrder,
                AppendTo: this.scriptLoaderOptions.appendTo
            }).script(a).wait(function() {
                b()
            })
        }
    }
